...
/**
 * The <code>ConnectionVerifierDef</code> annotation is used to designate hidden stages that are Connection Verifiers
 */
...
public @interface ConnectionVerifierDef {
     ...
     */
    String connectionSelectionFieldName();
}
