...
/**
 * Special data-format service that will always use SDC_RECORD as the output format and thus have no
 * input parameters in the UI to configure. This is particularly helpful for error stages that always
 * serialize SDC_RECORD.
 */
